        ...
        <div class="control-panel__container">
            ...
            <ul class="control-panel__list">
                ...
                <li class="control-panel__list-item">
                    <a class="control-panel__list-link" href="<?= HOST ?>admin/blog">
                        <div class="control-panel__list-img-wrapper">
                            <img class="control-panel__list-img" src="<?= HOST ?>static/img/control-panel/book.svg"
                                 alt="icon"/>
                        </div>
                        Блог
                    </a>
                ...
                <li class="control-panel__list-item"><a class="control-panel__list-link" href="#">
                        <div class="control-panel__list-img-wrapper"><img class="control-panel__list-img"
                ...
                <li class="control-panel__list-item">
                    <a class="control-panel__list-link" href="<?=HOST?>admin/contacts">
                        <div class="control-panel__list-img-wrapper">
                            <img class="control-panel__list-img" src="<?= HOST ?>static/img/control-panel/mail.svg"
                                 alt="icon"/>
