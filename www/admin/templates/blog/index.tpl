<div class="admin-page__content-form">
    <div class="admin-form" style="width: 900px;">
        ...
        <div class="admin-form__item d-flex justify-content-between mb-20">
            <h2 class="heading">Блог - все записи </h2><a class="secondary-button" href="<?= HOST ?>admin/post-new">Добавить
                пост</a>
        </div>
        ...
        <table class="table">
            ...
            <?php foreach ($posts as $post): ?>
                <tr>
                    <td><?= $post['id'] ?></td>
                    <td>
                        <a href="<?php echo HOST . "admin/"; ?>post-edit?id=<?= $post['id'] ?>"><?= $post['title'] ?></a>
                    </td>
                    <td>
