...
--
-- Хост: database:3306
-- Время создания: Июн 16 2025 г., 11:04
...
(3, 'Виктор', 'er@ty.com', 'Привет 2', 1749112924, NULL),
(4, 'КОля', 'uy@we.ru', '123456', 1749117361, NULL),
(5, 'КОля', 'uy@we.ru', '123456', 1749117377, NULL),
(6, 'КОля', 'uy@we.ru', '123456', 1749117919, NULL),
(7, 'КОля', 'uy@we.ru', '123456', 1749118105, NULL),
(8, 'КОля', 'uy@we.ru', '123456', 1749118261, NULL),
(9, 'КОля', 'uy@we.ru', '123456', 1749118308, NULL),
(10, 'КОля', 'uy@we.ru', '123456', 1749118315, NULL),
(11, 'Viktor', 'qw@qw.ry', 'Hello', 1750055049, NULL),
(12, 'dfdf', 'wer@df.tu', 'dffs', 1750055169, NULL),
(13, 'fgfg', 'fgf@ere', 'email', 1750061409, NULL);
...
(8, 'settings', 'site_slogan', 'IT СПЕЦИАЛИСТ'),
(9, 'settings', 'copyright_name', '© Сергей Козлов'),
(10, 'settings', 'copyright_year', 'Создано в 2025 году.'),
(11, 'settings', 'status_on', 'on'),
(12, 'settings', 'status_label', 'Свободен для новых проектов'),
(13, 'settings', 'status_text', 'Рассматриваю предложения frontend разработке. Подробности'),
(14, 'settings', 'status_link', 'http://project-prepare/contacts'),
(15, 'settings', 'youtube', 'youtube'),
