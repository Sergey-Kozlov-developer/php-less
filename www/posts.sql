...
--
-- Хост: database:3306
-- Время создания: Май 27 2025 г., 11:33
...
(5, 'лучшее место в ЛО', 'В общем, это лучшее место в ЛО, на наш вкус😊 Есть, с чем сравнить.\r\nЗдесь все условия для восстановления сил: тишина, удаленность от соседей, купель и баня при желании.\r\nМожно покататься на лодке или сапах по Вуоксе (но мы не рискнули).\r\nДом встретил теплом, светом, атмосферной музыкой и приятными ароматами.\r\nДороговато, в сравнении даже с Охта парком, но почти полное отсутствие соседей с лихвой перекрывает этот финансовый минус.\r\nНе могу сказать, что собака в восторге, ведь она расслабляется только в своей берлоге на любимом диване. Ну а нам очень понравилось! Местечко называется Lagom и находится рядом с чудесным Приозерском', '718644127157.jpg', '290-718644127157.jpg', 1747830187, NULL, NULL, 3),
(6, 'Домик', 'Еще фото с отпуска😎\r\nИногда мне кажется, что Молли очень маленькая. Но потом смотрю на фото, и она уже не кажется такой миниатюрной', '215410531941.jpg', '290-215410531941.jpg', 1747830234, NULL, NULL, 1),
(7, 'Ура! Мы в эфире!', '<p>Очень давно не было инфы, а у Молли вот что приключилось 👀 Эти красные лапы не от переедания и не от щенячьего корма. Но будем последовательны. Эта краснота преследует ее целый год. И собака до такой степени расчесала кожу, что выдрала почти все волосы на задних лапах🤨 Мы решили все-таки поехать к ветеринару. Классный доктор! Зависали мы у него целый час, пока он смотрел в свои микроскопы и тыкал в нас ультрафиолетом. Вспотели и устали. Собака распыхтелась. Оказалось, что это долбаный грибок и какой-то невидимый кожный клещ. А еще мы узнали, что шампунь для лап у нас не с хлоргексидином, а с говном😕 И теперь Молли лечится специальными шампунями и таблетками. Пожелайте ей удачи🤞🏻 P.S. Это не критично и не опасно. Просто кто-то год назад потрогал ее грязными лапами.</p>\r\n', NULL, NULL, 1747830271, NULL, 1748339259, 1),
...
(14, 'Туса', 'Это Молли ищет того, кого можно подоставать 😆', '295170472971.jpg', '290-295170472971.jpg', 1747830681, NULL, NULL, 1),
